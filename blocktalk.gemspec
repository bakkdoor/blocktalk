...
#             "{grammar,lib,bin,examples,language-spec,parser}/**/*"].map{|p| Dir[p]}.flatten
  s.files = ["README.markdown", "benchmark.bt", "TODO", "LICENSE", "evaluator.rb",
             ...
             "parser/helpers", "parser/helpers/method_definitions.rb", "parser/helpers/methodcalls.rb", "parser/nodes.rb",
             "parser/nodes", "parser/nodes/message_without_params.rb", "parser/nodes/block_literal.rb",
             "parser/nodes/integer_literal.rb", "parser/nodes/require.rb", "parser/nodes/expression.rb",
             "parser/nodes/try.rb", "parser/nodes/comment.rb", "parser/nodes/multiple_methodcall.rb",
             "parser/nodes/root.rb", "parser/nodes/string.rb", "parser/nodes/message_receiver.rb",
             "parser/nodes/method_definition.rb", "parser/nodes/subexpression.rb", "parser/nodes/catch.rb",
             "parser/nodes/identifier.rb", "parser/nodes/ensure.rb", "parser/nodes/operator_message.rb", "parser/nodes/return.rb",
             "parser/nodes/yield.rb", "parser/nodes/class_method_definition.rb", "parser/nodes/super_call.rb",
